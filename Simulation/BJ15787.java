        ...
        while (operation-- > 0){
            ...
            switch (op) {
                case ADD:
                    ...
                    break;
                case REMOVE:
                    remove(Integer.parseInt(st.nextToken())-1, Integer.parseInt(st.nextToken())-1);
                    break;
                case SHIFT_LEFT:
                    shiftLeft(Integer.parseInt(st.nextToken())-1);
                    break;
                case SHIFT_RIGHT:
                    shiftRight(Integer.parseInt(st.nextToken())-1);
                    break;
                default:
                    break;
            }
